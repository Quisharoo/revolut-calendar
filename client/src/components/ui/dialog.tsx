  ...
  <DialogPortal>
    ...
    >
      <div className="relative w-full max-w-md rounded-lg border border-border bg-popover shadow-lg">
        <DialogPrimitive.Close className="absolute right-3 top-3 rounded-sm p-1 text-muted-foreground opacity-70 transition hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring">
          <X className="h-4 w-4" />
...
const DialogHeader = ({
  ...
  <div className={cn("space-y-1.5 border-b border-border px-6 pb-4 pt-6", className)} {...props} />
);
